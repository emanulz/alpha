    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='general.Company', verbose_name='Compa\xf1\xeda')),
            ],
            options={
                'ordering': ['code'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='general.Company', verbose_name='Compa\xf1\xeda')),
            ],
            options={
                'ordering': ['id'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='general.Company', verbose_name='Compa\xf1\xeda')),
                ('department', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.SET_NULL, to='general.ProductDepartment', verbose_name='Familia')),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='inventory_product', to='general.Product', verbose_name='Producto')),
            ],
            options={
                'ordering': ['code'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='general.ProductDepartment', verbose_name='Familia')),
            ],
            options={
                'ordering': ['id'],
        ...
        migrations.AddField(
            ...
            name='subdepartment',
            field=models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.SET_NULL, to='general.ProductSubDepartment', verbose_name='Sub-Familia'),
        ),
        migrations.AddField(
            model_name='product',
            name='department',
            field=models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.SET_NULL, to='general.ProductDepartment', verbose_name='Familia'),
        ),
        migrations.AddField(
            model_name='product',
            name='subdepartment',
