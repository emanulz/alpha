...
/***/ function(module, exports, __webpack_require__) {
	...
	var _listData = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function dataToHTML($main) {
	    ...
	    var categories = JSON.parse(localStorage.account_categories);
	    var groups = JSON.parse(localStorage.account_groups);
	    var accounts = JSON.parse(localStorage.accounts);
	    var subaccounts = JSON.parse(localStorage.subaccounts);
	    var detailaccounts = JSON.parse(localStorage.detailaccounts);
	    ...
	    $.each(categories, function (i) {
	        ...
	        var grepGroups = $.grep(groups, function (element, index) {
	        ...
	        $.each(grepGroups, function (i) {
	            ...
	            var grepAccounts = $.grep(accounts, function (element, index) {
	            ...
	            $.each(grepAccounts, function (i) {
	                ...
	                var grepSubAccounts = $.grep(subaccounts, function (element, index) {
	                ...
	                $.each(grepSubAccounts, function (i) {
	                    ...
	                    var grepDetailAccounts = $.grep(detailaccounts, function (element, index) {
