    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='general.Company', verbose_name='Compa\xf1\xeda')),
                ('department', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.SET_NULL, to='sales.ProductDepartment', verbose_name='Familia')),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='inventory_product', to='sales.Product', verbose_name='Producto')),
            ],
            options={
                'ordering': ['code'],
